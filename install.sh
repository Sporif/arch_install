...
###############
    ...
    ## PACKAGES
    # Base
    BASE_PKGS="base base-devel btrfs-progs e2fsprogs xfsprogs linux linux-firmware bash-completion nano man-db man-pages usbutils"
    # Boot Loader
    ...
    GRAPHICS=$QEMU
    # Desktop Env
    PLASMA="sddm kwin plasma-desktop polkit-kde-agent plasma-pa plasma-nm kde-gtk-config breeze-gtk kdeplasma-addons
